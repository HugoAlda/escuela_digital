...
<div class="container">
    <div class="section-title">
        <h2>Benvinguts al Pla de Transformació Digital</h2>
    </div>
    ...
    <div class="card-grid">
        <div class="card">
            ...
            <p>Compra i registre de tiquets de menjador per alumne i dia.</p>
        </div>
        <div class="card">
        ...
        <div class="card">
            ...
            <p>Catàleg de documents acadèmics associats a cada alumne.</p>
        </div>
    </div>
</div>
